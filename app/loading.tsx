      ...
      <div className="relative z-10 w-full max-w-md">
        ...
        <div className="card-premium text-center mb-8">
          <div className="mb-6 flex justify-center">
            <div className="w-32 h-32 rounded-2xl bg-white/20 animate-pulse"></div>
          </div>
          
          <div className="h-10 w-48 mx-auto bg-white/20 rounded animate-pulse mb-3"></div>
          <div className="h-6 w-64 mx-auto bg-white/20 rounded animate-pulse"></div>
        </div>
        
        {/* Sign in card skeleton */}
        <div className="card-premium text-center">
          <div className="h-8 w-40 mx-auto bg-white/20 rounded mb-2 animate-pulse"></div>
          <div className="h-5 w-56 mx-auto bg-white/20 rounded mb-8 animate-pulse"></div>
          
          <div className="flex justify-center">
            <div className="h-12 w-full max-w-sm bg-white/20 rounded-md animate-pulse"></div>
          </div>
          
          <div className="mt-8 pt-6 border-t border-white/10">
            <div className="h-4 w-48 mx-auto bg-white/20 rounded animate-pulse"></div>
          </div>
        </div>
        ...
        <div className="mt-8 grid grid-cols-3 gap-4">
          {[1, 2, 3].map((i) => (
            <div key={i} className="glass rounded-xl p-4 text-center">
              <div className="w-8 h-8 mx-auto bg-white/20 rounded mb-2 animate-pulse"></div>
